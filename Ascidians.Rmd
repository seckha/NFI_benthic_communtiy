...
# order the TPs
# this does not work because then the 69 ASCD suddenly show up in April 2022, not April 2023
ascidians.sum$TP <- as.factor(ascidians.sum$TP)
levels(ascidians.sum$TP) <- c("Dec_2020", "April_2021", "April_2022", "Sept_2022", "Dec_2022",  "April_2023")
