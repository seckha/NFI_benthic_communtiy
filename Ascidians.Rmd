...
# Dotplot
ggplot(transect.percent.cover, aes(x = Site, y = percent_cover, fill = TP)) +
  geom_dotplot(binaxis = "y", stackdir = "center", dotsize = 0.6, show.legend = TRUE) +
  labs(x = "Time Points", y = "Percent Cover (%)") +
  scale_fill_discrete(name = "Site") +
  theme_classic()
```
